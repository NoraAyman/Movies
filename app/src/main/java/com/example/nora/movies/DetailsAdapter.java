...
public class DetailsAdapter extends ArrayAdapter<MoviePersonDetails>{
    ...
    @Override
    public int getPosition(MoviePersonDetails item) {
        return super.getPosition(item);
    }
    public DetailsAdapter(Context context, List<MoviePersonDetails> movies){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(listItemView== null){
            if(this.linkStatus == false && this.personStatus== false){
                ...
                MoviePersonDetails currentMovie= getItem(position);
                ...
                MoviePersonDetails currentPerson= getItem(position);
