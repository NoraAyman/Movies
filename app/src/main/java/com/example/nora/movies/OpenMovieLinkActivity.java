...
public class OpenMovieLinkActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    private static final String THEMOVIEDB_MOVIE_REQUESTED_URL = "http://api.themoviedb.org/3/movie/";
    public OpenMovieLinkActivity(){
        //id= 0;
    }
    public OpenMovieLinkActivity(int id, Boolean status){
        this.id= id;
        this.status=status;
    }
    @Override
