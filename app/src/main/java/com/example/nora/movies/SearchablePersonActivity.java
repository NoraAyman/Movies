...
public class SearchablePersonActivity  extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener,
    ...
    public SearchablePersonActivity()
    {
        //query= "";
    }
    public SearchablePersonActivity(String query){
    ...
    public Loader<List<PersonDetails>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new PersonDetailsLoader(this, PERSON_SEARCH + this.query);
    }
    @Override
